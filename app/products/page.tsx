          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-muted max-w-3xl mx-auto">
                Pair your sunglasses rack with high-demand charging and audio essentials that customers grab on impulse.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-5 flex flex-col justify-between">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-1">4-In-1 Cable</h3>
              ...
              <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-5 flex flex-col justify-between">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-1">C To C Cable</h3>
                  <p className="text-xs text-accent font-semibold mb-2">Super Fast</p>
                  <p className="text-sm text-muted">
              ...
              <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-5 flex flex-col justify-between">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-1">Dual Car Charger</h3>
                  <p className="text-xs text-accent font-semibold mb-2">Super Fast</p>
                  <p className="text-sm text-muted">
              ...
              <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-5 flex flex-col justify-between">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-1">Wall Charger</h3>
                  <p className="text-xs text-accent font-semibold mb-2">Super Fast</p>
                  <p className="text-sm text-muted">
              ...
              <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-5 flex flex-col justify-between">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-1">Earbuds</h3>
              ...
              <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-5 flex flex-col justify-between">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-1">USB To C Cable</h3>
                  <p className="text-xs text-accent font-semibold mb-2">Super Fast</p>
                  <p className="text-sm text-muted">
              ...
              <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-5 flex flex-col justify-between">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-1">USB to Lightning Cable</h3>
                  <p className="text-xs text-accent font-semibold mb-2">Super Fast</p>
                  <p className="text-sm text-muted">
